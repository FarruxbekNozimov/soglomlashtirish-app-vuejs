        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow-xl dark:bg-gray-800 sm:p-5">
          ...
          <div class="flex justify-center items-center space-x-4">
            <button
              @click="toggleDelete"
              type="button"
              class="py-2 px-3 text-sm font-medium rounded-lg border border-gray-200 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:bg-blue-900 focus:z-10 bg-main-bg text-white"
            >
              Yo'q, hazillashdim
            </button>
            <button
        ...
        <form @submit.prevent="addStudent" class="relative bg-white rounded-xl shadow-xl">
          ...
          <div class="flex items-start justify-between p-4 border-b rounded-t-xl bg-main-bg">
            ...
            <button
              @click="toggleModal"
              type="button"
              class="text-blue-400 bg-transparent hover:bg-blue-200 hover:text-blue-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center"
            >
              <svg
                aria-hidden="true"
                class="w-5 h-5"
          ...
          <div class="flex items-center justify-end p-6 space-x-10 rounded-b">
            <button
              type="submit"
              class="text-white bg-main-bg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-lg px-5 py-2.5 text-center"
            >
              Qo'shish
            </button>
          </div>
      ...
      <div class="relative w-full max-w-full h-[90vh]">
        ...
        <form @submit.prevent="editStudent" class="relative bg-white rounded-xl shadow-xl">
          ...
          <div class="flex items-center justify-end p-6 space-x-10 rounded-b">
            <button
              type="submit"
              class="text-main-bg bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-full border-[3px] border-main-bg text-lg font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10"
            >
              Saqlash
            </button>
          </div>
